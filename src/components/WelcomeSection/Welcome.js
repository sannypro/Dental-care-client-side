        ...
        <>
            <div className='row container align-items-center justify-content-center'>
                ...
                <div className='col-lg-6 col-sm-12 '>
                    ...
                    <h2> welcome to My dental care</h2>
                    <p>My goal is to make high quality dental care accessible to all residents of my great state.My vision is to gather the best oral health professionals in the state of Utah.</p>
                </div>
            </div>
            <div className='dream text-center py-5 mt-5'>
                <h2>Make your dream smile a reality</h2>
                <small>Call me or book your appointment today</small>
            </div>
            <Services></Services>
